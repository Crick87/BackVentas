...
select orderid o_orderid, customerId o_customerid, status o_status, orderdate o_orderdate,completeddate o_completeddate,quantity o_quantity, p.id p_id, p.name p_name, p.description p_description, price p_price
    from orders o
                     join customer_order on o.id = customer_order.orderId
